	...
	<main id="wrapper">
		...
		<ul class="reports">
			<?php foreach($reports as $report) { ?>
				...
				<li><?php echo $report['userreportid']; ?> -- <?php echo $report['userreportreasoncodeid']; ?> -- <?php echo $report['moreinfo']; ?><br>Comment: <?php echo $comment['commenttext']; ?><br>Posted by: <?php echo $comment['username']; ?></li>
			<?php } ?>
